...
* NPQ will audit a package for possible security issue but it isn't a replacement for npm or yarn, when you choose to continue installing the package it will offload the installation process to either npm or yarn (depends on your choosing).
