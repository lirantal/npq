...
describe('older release suggestions', () => {
  ...
  test('renders one package-level suggestion after findings in rich and plain output', () => {
    ...
    const prettySuggestionIndex = result.resultsForPrettyPrint.indexOf(
    ...
    expect(result.resultsForPrettyPrint).toContain(
      "Clears npq's package-version recency windows."
    )
