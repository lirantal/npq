...
class packageManager {
  static process (packageManager) {
    packageManager = packageManager.validatePackageManager(packageManager)
    return packageManager.spawnPackageManager(packageManager)
  }
  ...
  static validatePackageManager (packageManager) {
    if (!packageManager) {
      packageManager = packageManager.getDefaultPackageManager()
    }
