...
Options:
      ...
      --disable-auto-continue Disable countdown; prompt when interactive
...
curated by Liran Tal at https://github.com/lirantal/npq`)
  ...
  static parseArgsMinimal({ codingAgentEnvironment = isCodingAgentEnvironment() } = {}) {
    ...
    try {
      normalizedPackages = this._extractPackagesFromPositionals(
        positionals,
        true,
        jsonPackageParsing
      )
    } catch (error) {
      if (jsonPackageParsing && error && typeof error === 'object') {
