...
class Marshall extends BaseMarshall {
  ...
  async validate(pkg) {
    ...
    if (!firstVersionForUser || firstVersionForUser.version === packageVersion) {
      // @TODO it will be good to consider another indicator here to determine actual
      // risk, such as how long this version has been published for and
      // how many versions have been published since then, to potentially lower the risk
      throw new Error(
