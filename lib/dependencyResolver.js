...
class DependencyResolver {
  ...
  getDependencies ({ noDev = false, onlyDev = false }) {
    ...
    if (!onlyDev) this.dependencies = getDepList(this.packageJson.dependencies || {})
    if (!noDev) this.dependencies = [...this.dependencies, ...getDepList(this.packageJson.devDependencies || {})]
  }
}
